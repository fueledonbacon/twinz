      ...
      <div class="shadow overflow-hidden sm:rounded-md">
        <div class="py-5">
          <div class="mb-4">
            ...
            <p class="bg-transparent mt-1 text-sm">Address where you will receive your merch and email for shipping updates.</p>
          </div>
          <div class="grid grid-cols-6 gap-6">
            <div class="col-span-6 sm:col-span-3">
              <label for="first-name" class="block text-sm font-medium">First name</label>
              <input v-model="first_name" type="text" name="first-name" id="first-name" autocomplete="given-name" />
            </div>

            <div class="col-span-6 sm:col-span-3">
              <label for="last-name" class="block text-sm font-medium">Last name</label>
              <input v-model="last_name" type="text" name="last-name" id="last-name" autocomplete="family-name" />
            </div>
            ...
            <div class="col-span-6">
              ...
              <input v-model="address1" placeholder="Address 1" type="text" name="street-address" id="street-address" autocomplete="street-address" />
              <input v-model="address2" placeholder="Address" type="text" name="street-address-2" id="street-address-2" autocomplete="street-address-2" />
            </div>

            <div class="col-span-6 sm:col-span-6 lg:col-span-2">
              <label for="city" class="block text-sm font-medium">City</label>
              <input v-model="city" type="text" name="city" id="city" autocomplete="address-level2" />
            </div>

            <div class="col-span-6 sm:col-span-3 lg:col-span-2">
              <label for="region" class="block text-sm font-medium">State/Province</label>
              <input v-model="province" type="text" name="region" id="region" autocomplete="address-level1" />
            </div>

            <div class="col-span-6 sm:col-span-3 lg:col-span-2">
              <label for="postal-code" class="block text-sm font-medium">ZIP/Postal Code</label>
              <input v-model="zip" type="text" name="postal-code" id="postal-code" autocomplete="postal-code" />
            </div>
            <div class="col-span-6 sm:col-span-6 lg:col-span-2">
              <label for="country" class="block text-sm font-medium">Country<br/> <span class="text-xs">(2-Letter Code)</span></label>
              <input v-model="country" type="text" name="country" id="country" autocomplete="country" />
            </div>
          </div>
        </div>
        ...
        <div v-if="!fresh && errors.length > 0" class="bg-orange-700 rounded-sm p-4 my-4">
          <p v-for="(msg, i) in errors" :key="`form_validation_error_${i}`">{{ msg }}</p>
        </div>
      </div>
    </form>
  </div>
