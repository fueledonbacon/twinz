		...
		<div class="container mx-auto flex flex-col px-8 pt-40 pb-20 lg:flex-row">
			<div class="mb-16 w-full lg:mb-0 lg:w-1/2 lg:pr-20 lg:pr-32">
				...
				<div class="text-light">
					...
					opportunities that will strengthen the community and increase value long
					term.
				</div>
			</div>
				...
				<div class="relative mb-8">
					...
					<div
						...
						<div class="text-light">
							...
							split among all OT holders.
						</div>
					</div>
					<div
						class="absolute top-[40%] left-0 h-5 w-5 translate-x-[-10px] rounded-full bg-primary" />
				</div>
				<div class="relative mb-8">
					<div
						class="relative rounded-tr-[150px] bg-neutral-500/20 p-10 pr-16 backdrop-blur-sm">
						...
						<div class="text-light">
							...
							rewards that are split among all Identical TwinZ stakers.
						</div>
					</div>
					<div
						class="absolute bottom-0 right-[10%] h-5 w-5 translate-y-1/2 rounded-full bg-primary" />
				</div>
				<div class="relative mb-8">
					<div
						class="relative rounded-tr-[150px] bg-neutral-500/20 p-10 pr-16 backdrop-blur-sm">
						...
						<div class="text-light">
							...
							of monthly rewards that are split among all Fraternal TwinZ stakers.
							Fraternal TwinZ are harder to match resulting in lower stakers.
						</div>
					</div>
					<div
						class="absolute top-[66%] left-0 h-5 w-5 translate-x-[-10px] rounded-full bg-primary" />
				</div>
				<div class="relative mb-8">
					<div
					...
					<div
						...
						<div class="text-light">
							...
							stakers and multiplied by the number of TwinZ staked. With only 500 Sets
							of Exclusive TwinZ and the extreme difficulty of matching them the number
							of actual stakers may be low.
						</div>
					</div>
				</div>
			</div>
