<template>
	<section class="w-full bg-black py-16 lg:py-24">
		<div class="mx-auto max-w-7xl px-12 text-center">
			<div class="space-y-12 md:text-left">
				<div
					class="mb-20 space-y-5 sm:mx-auto sm:max-w-xl sm:space-y-4 md:max-w-2xl lg:max-w-5xl">
					<h3
						class="sans-serif text-center font-[bowlby] text-xl leading-none tracking-[2px] text-white sm:text-3xl md:text-[40px] lg:leading-7">
						Our Team
					</h3>
				</div>
				<div
					class="mx-auto space-y-16 sm:grid sm:grid-cols-2 sm:gap-16 sm:space-y-0 lg:max-w-5xl lg:grid-cols-3">
					<div class="space-y-6 text-center md:ml-10 lg:ml-0">
						<div class="relative mx-auto h-48 w-48 p-2 md:h-56 md:w-56">
							<img
								class="relative z-20 h-full w-full rounded-xl"
								src="https://cdn.devdojo.com/images/june2021/avt-05.jpg"
								alt="" />
							<svg
								class="absolute inset-0 h-full w-full scale-150 transform fill-current text-pink-500 opacity-10"
								viewBox="0 0 200 200"
								xmlns="http://www.w3.org/2000/svg">
								<path
									d="M34.2,-54.9C47,-51.8,62,-48.1,70.2,-38.9C78.4,-29.6,79.9,-14.8,80,0.1C80.2,14.9,78.9,29.9,70.8,39.3C62.6,48.7,47.6,52.6,34.7,57.1C21.7,61.6,10.9,66.7,-1.7,69.7C-14.3,72.7,-28.7,73.6,-42.4,69.6C-56.1,65.5,-69.2,56.5,-74.9,44.1C-80.6,31.7,-79,15.8,-77.6,0.8C-76.2,-14.2,-75,-28.4,-70.1,-42.3C-65.2,-56.2,-56.7,-69.8,-44.4,-73.2C-32.1,-76.6,-16.1,-69.9,-2.7,-65.2C10.7,-60.5,21.3,-58,34.2,-54.9Z"
					...
					<div class="space-y-6 text-center md:mr-10 lg:mr-0">
						<div class="relative mx-auto h-48 w-48 p-2 md:h-56 md:w-56">
							<img
								class="relative z-20 h-full w-full rounded-xl"
								src="https://cdn.devdojo.com/images/june2021/avt-17.jpg"
								alt="" />
							<svg
								class="absolute inset-0 mt-2 h-full w-full scale-150 transform fill-current text-green-500 opacity-10"
								viewBox="0 0 200 200"
								xmlns="http://www.w3.org/2000/svg">
								<path
									d="M42.7,-73.4C55,-67,64.3,-54.7,69.9,-41.5C75.5,-28.3,77.5,-14.2,76.5,-0.6C75.4,12.9,71.3,25.8,64.6,37.3C57.9,48.7,48.8,58.6,37.6,63.1C26.4,67.5,13.2,66.5,0.8,65.2C-11.6,63.8,-23.2,62.1,-34.9,57.9C-46.6,53.7,-58.4,47.1,-67.1,37.1C-75.9,27,-81.6,13.5,-83.1,-0.9C-84.6,-15.2,-81.9,-30.5,-73.2,-40.7C-64.6,-51,-50.1,-56.4,-36.9,-62.3C-23.8,-68.2,-11.9,-74.6,1.7,-77.5C15.2,-80.4,30.5,-79.8,42.7,-73.4Z"
									transform="translate(100 100)"></path>
							</svg>
						</div>
						<div class="space-y-2">
					...
					<div class="space-y-6 text-center md:ml-10 lg:ml-0">
						<div class="relative mx-auto h-48 w-48 p-2 md:h-56 md:w-56">
							<img
								...
								alt="" />
							<svg
								class="absolute inset-0 h-full w-full scale-150 transform fill-current text-yellow-500 opacity-10"
								viewBox="0 0 200 200"
								xmlns="http://www.w3.org/2000/svg">
								<path
					...
					<div class="space-y-6 text-center md:ml-10 lg:ml-0">
						<div class="relative mx-auto h-48 w-48 p-2 md:h-56 md:w-56">
							<img
								class="relative z-20 h-full w-full rounded-xl"
								src="https://cdn.devdojo.com/images/june2021/avt-18.jpg"
								alt="" />
							<svg
								class="absolute inset-0 h-full w-full scale-150 transform fill-current text-pink-500 opacity-10"
								viewBox="0 0 200 200"
